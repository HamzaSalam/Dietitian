        ...
        <div className='container grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative'>
            ...
            <div className='flex flex-col justify-center py-14 md:py-0 relative z-10'>
                <div className='text-center md:text-left space-y-6 lg:max-w-[400px]'>
                    ...
                    animate="visible"
                     ...
                     font-averia'>Healty
                     <br/>
                     Fresh <span className='text-secondary'>Friuts!</span>
                     </motion.h1>
                     <motion.p
                     ...
                     className='text-2xl tracking-wide'>
                        Lorem ipsum dolor sit amet life.</motion.p>
                     <motion.p
                     ...
                     for good health and mind Order now and get 20% off on your first order
                     </motion.p> 
                     {/* Button section */}
                     <motion.div
            ...
            className='flex justify-center items-center'>
              ...
              className='absolute top-14 md:top-0 right-1/2
                ...
                <Image src={leafPng} alt='leaf' className='w-full md:max-w-[300px]'/>
              </motion.div>
        </div>
    </section>
    </>
